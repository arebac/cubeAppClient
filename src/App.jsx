...
function ProtectedRoute({ children, allowedRoles = ['user', 'coach', 'admin'] }) {
    ...
    <AuthProvider>
      <Router>
        ...
        <Routes>
          ...
          <Route path="/subs" element={<SubsPage />} /> {/* Subs page is public */}
          ...
          {/* --- PROTECTED DROP-IN ROUTE --- */}
           <Route path="/drop-in" element={
            <ProtectedRoute allowedRoles={['user', 'coach']}> {/* Wraps DropIn, allows user/coach */}
              <DropIn />
            </ProtectedRoute>
          } />
